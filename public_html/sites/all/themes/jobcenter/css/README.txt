...
To use these stylesheets, rename the files and jobcenter with the name of your theme.
...
jobcenter-alpha-default-narrow.css  
...
jobcenter-alpha-default-normal.css
...
jobcenter-alpha-default-wide.css
